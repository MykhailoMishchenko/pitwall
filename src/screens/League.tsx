          ...
          <div style={{ display: 'grid', gap: 14, alignContent: 'start' }}>
            <Panel hot>
              ...
              <p className="sub" style={{ fontSize: 12.5, marginTop: 8 }}>
                Подзигун (коментатор F1) — ЛІДЕР ліги за сезон. Ми дебютуємо з R10 з нуля, тому відставання велике; ціль — набирати найбільше очок з кожного нашого туру й дертися вгору.
              </p>
            </Panel>
            <Panel>
