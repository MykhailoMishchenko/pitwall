...
type StructuredPreview = {
  ...
  weather: { day?: string; tempC?: number; condition?: string; conditionLabel?: string; windMs?: number; rainPct?: number; summary: string; detail: string; risk?: string }
